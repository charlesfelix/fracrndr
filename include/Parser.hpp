...
namespace Fr
{
    class Parser
    {
        ...
        virtual const std::map<std::string,Primitive::Ptr > & getPrimitives() const = 0;
    ...
    public:
        ...
        virtual const std::map<std::string,Primitive::Ptr > & getPrimitives() const;
    ...
    private:
        ...
        std::map<std::string,Primitive::Ptr > m_primitives;
